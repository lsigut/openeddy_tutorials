...
green arrow (top right inside the box) or line by line using
*Ctrl+Enter*.
...
First let´s read the R packages we will use.
...
-   `remap_vars`: basically renames specified columns of a data frame.
    Useful for regular switching between defined variable naming
    conventions.
